...
## Features
1. **Multi-Step Form Application Submission**: Students can submit their applications through a multi-step form. Upon submission the data will get saved in a file - data.txt at backend.
3. **Preview**: Students can preview the application.
3. **Save as Draft**: Students can save the draft appliation( will be saved in localstorage).
3. **Preview**: Students can preview the application.
3. **Preview**: Students can preview the application.
2. **Chatbot**: A chatbot to assist students in the application process.
...
[See the screenshot here](./screenshots/1.form.png)
...
## To be Worked upon
- **Performace Optimization**: Optimizing client rendering performance for react components.
